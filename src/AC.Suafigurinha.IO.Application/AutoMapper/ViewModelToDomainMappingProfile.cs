using System;
using AutoMapper;
//using AC.Suafigurinha.IO.Application.ViewModels;
//using AC.Suafigurinha.IO.Domain.Eventos.Commands;
//using AC.Suafigurinha.IO.Domain.Organizadores.Commands;

namespace AC.Suafigurinha.IO.Application.AutoMapper
{
